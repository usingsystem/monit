...
class User < ActiveRecord::Base
  ...
  validates_format_of       :mobile,   :with => /^0{0,1}1[0-9]{10}$/, :allow_blank => true
  ...
  attr_accessible :login, :email, :username, :name, :password, :password_confirmation,:work_number,
    :birthday,:role_id,:company,:department,:job,:phone,:mobile,:description,
    :creator,:state, :old_password
