%%%----------------------------------------------------------------------
%%% File    : check_virmem_hr.erl
%%% Author  : Ery Lee <ery.lee@gmail.com>
%%% Purpose : check virtual mem usage by host-resources-mib
%%% Created : 09 Apr. 2010
%%% License : http://www.monit.cn
%%%
%%% Copyright (C) 2007-2010, www.monit.cn
%%%----------------------------------------------------------------------
-module(check_virmem_hr).
...
run(Args) ->
    ...
    {ok, Disk} ->
        ...
        Summary = lists:flatten(["virtual memory usage = ", integer_to_list(Usage), "%"]),
